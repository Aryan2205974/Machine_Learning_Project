...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        ...
        try:
            ...
            return preprocessor
        # A preprocessing pipeline refers to a sequence of data transformation steps that are applied to raw data before it is used in a machine learning model. It ensures that data is cleaned, standardized, and prepared in a systematic way.
